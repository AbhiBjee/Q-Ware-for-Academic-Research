...
class Q1_Visual_GUI(object):
    ...
    def setupUI (self, Frame):
        ...
        #win.resize(1200,700)
        Frame.setWindowTitle('QSTM Q1 Visualization')
...
##
    def storeData(self):
        ...
        if (self.RT_PlotInterrupt==1) and (self.DevState==0):
            ...
            self.Rg = (float)(self.serialElements[7])# Yg = IMU z MPU9250
...
##
    ...
    def GetStarted(self, serialComm):
        ...
        while (True):
            ...
            if self.dataString.startswith('T:Q1'):
                self.startFlag=1
