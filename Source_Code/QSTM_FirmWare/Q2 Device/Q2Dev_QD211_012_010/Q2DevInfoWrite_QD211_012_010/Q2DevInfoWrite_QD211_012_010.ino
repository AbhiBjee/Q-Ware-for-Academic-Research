...
void setup() {
  ...
  sprintf(QDevInfoStr,
    "QSTM Device\r\n\n"
    "Product Info\r\n\n"
    "OEMI: QD1642639919\r\n"// Equipment Manufacture Id: QD-UnixTime
    "Version: v2K22a\r\n"//v year revision
    "Hardware ID: QD211_012_010\r\n"//Q D (Common Left Right SR) -  LeftloadCell Serial RightloadCell Serial    
    //"Hardware ID: Q190718X190809D\r\n"//Q LeftloadCell Serial X RightloadCell Serial D
  ...
  sprintf(QDevInfoStr,
    "Load Cell Info\r\n\n"
    "Left Load Cell\r\n"
    "Serial Number: UL211012\r\n"
    "Product Number: USL06-H12-100N-AP\r\n"// Tech-Gihan Product Number
    );

  file.print(QDevInfoStr);
  sprintf(QDevInfoStr,
    "\nCalibration Info Left Cell\r\n\n"
    "FCL11 = 24.8146, FCL12 = -0.1221, FCL13 = -1.1215\r\n"
    "FCL21 =  -0.6600, FCL22 = 24.1581, FCL23 =  1.1665\r\n"
    "FCL31 =  -0.0925, FCL32 = -0.0534,  FCL33 = 49.9848\r\n"        
    );
  ...
  sprintf(QDevInfoStr,
    //"Load Cell Info\r\n\n"
    "Right Load Cell\r\n"
    "Serial Number: UL211010\r\n"
    "Product Number: USL06-H12-100N-AP\r\n"// Tech-Gihan Product Number
    );

  file.print(QDevInfoStr);
  sprintf(QDevInfoStr,
    "\nCalibration Info Right Cell\r\n\n"
    "FCR11 = 25.6994, FCR12 =  -1.3825, FCR13 = -1.1478;\r\n"
    "FCR21 =  0.8705, FCR22 = 24.3617, FCR23 = 0.8009\r\n"
    "FCR31 = -0.1637, FCR32 =  0.4033, FCR33 = 50.2335\r\n"       
    );
