...
/*// Force Sensor (Left) Calibration Matrix - UL211014 (Q1-vk2022a)
const double FCL11 = 24.1332, FCL12 = -0.1051,  FCL13 = 0.8953;
const double FCL21 =  0.0813, FCL22 = 27.0690, FCL23 = -2.4297;
const double FCL31 = 0.2713, FCL32 = 0.8161,  FCL33 = 49.7078;*/


// Force Sensor (Left) Calibration Matrix - UL2110002 (Q1-vk2022a)
const double FCL11 = 27.4248, FCL12 = 0.1207,  FCL13 = -2.8807;
const double FCL21 =  0.2179, FCL22 = 25.0442, FCL23 = 0.0011;
const double FCL31 = 0.6573, FCL32 = 0.8675,  FCL33 = 50.1805;
...
void loop() {
    ...
    if (calibFlag == 1){// one time Calibration.
      ...
      //eventTimer.begin([] {MainCallBack();}, 1'000); // 1ms or 1000Hz 
